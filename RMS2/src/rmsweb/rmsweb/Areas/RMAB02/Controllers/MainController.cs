...
namespace RMAB02.Controllers
{
    public class MainController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            string col = ",r.Closed,r.Confirmed";
            string condition = ",=,=";
            string value = ",N,Y";
        ...
        public ActionResult Index(string s)
        {
            ...
            else if (Request.Form["action"] == "btnExport")
            {
                ...
                //    sw.WriteLine("單別,單據名稱,單號,客戶簡稱,品號,品名,序號,接收日期,建立人員");
            ...
            else
            {
                ...
                if (Request.Form["ReceiveDate"].Trim() != "")
                {
                    col += ",r.OrderDate";
                    condition += "," + Request.Form["selCond2"];
                    value += "," + Request.Form["ReceiveDate"];
                }
                ViewData["RMAApl"] = logic.SearchRMAApl(col, condition, value);
                ViewBag.strAdvCol = col;
                ViewBag.strAdvCondition = condition;
                ...
                ViewBag.confirmeddate = Request.Form["ReceiveDate"];
