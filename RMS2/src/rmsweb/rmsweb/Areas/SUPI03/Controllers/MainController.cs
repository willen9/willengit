...
namespace SUPI03.Controllers
{
    public class MainController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            //orderCategory.OrderCategoryID = "A";
        ...
        {
            OrderCategory orderCategory = new OrderCategory();
            orderCategory.Company = "";
            orderCategory.UserGroup = "";
            orderCategory.Creator = "";
        ...
        [HttpPost]
        public JsonResult OrderType(string OrderType)
        {
            OrderCategoryLogic logic = new OrderCategoryLogic();
            return Json(logic.IsOrderCategory(OrderType), JsonRequestBehavior.AllowGet);
        }
