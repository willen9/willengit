...
namespace SERI02.Controllers
{
    public class MainController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewData["OrderCategory"] = logic.GetOrderCategory(",OrderCategory", ",like%",",B", 0);
            return View();
        }
        ...
        [HttpPost]
        public JsonResult Delete(string OrderType,string OrderCategory)
        {
            OrderCategoryLogic logic = new OrderCategoryLogic();
            string msgInfo = "";
            string msg = "";
            if (!logic.DelOrderCategory(OrderType, OrderCategory.Substring(0,2),out msgInfo))
            {
                msg = "NO-刪除失敗!" + msgInfo;
            }
            else
